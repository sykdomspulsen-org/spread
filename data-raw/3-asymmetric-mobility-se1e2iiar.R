...
usethis::use_data(asymmetric_mobility_se1e2iiar_dummy_se1e2iiar_pop, overwrite = TRUE, version = 3, compress = "xz")
...
usethis::use_data(asymmetric_mobility_se1e2iiar_dummy_dynamic_seeds, overwrite = TRUE, version = 3, compress = "xz")
