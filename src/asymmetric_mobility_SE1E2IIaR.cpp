          ...
          if (name1_index == -1 || name2_index == -1){
            ...
            if(Nk_prev == Nk){
              ...
              if(sum >= Nk - Nk_prev){
                ...
                int S_tmp2 = 0; int E1_tmp2 = 0; int E2_tmp2 = 0; int Ia_tmp2 = 0; int I_tmp2 = 0; int R_tmp2 = 0;
                ...
                if(S_tmp2 + E1_tmp2 + E2_tmp2 + I_tmp2 + Ia_tmp2 + R_tmp2 < leftover){
                  ...
                  {
                    G_current.locations[name2_index].visitorsS[name1_index] += leftover - S_tmp2 - E1_tmp2 - E2_tmp2 - I_tmp2 - Ia_tmp2 - R_tmp2;
                    Rcout << "---------------" << endl;
                    Rcout << " Added extra people in " << tmpstr << " index " << name1_index << endl;
                    Rcout << " Name1 index " << name1_index << " Name2 index " << name2_index << endl;
                    Rcout << " Number added " << leftover - S_tmp2 - E1_tmp2 - E2_tmp2 - I_tmp2 - Ia_tmp2 - R_tmp2 << endl;
                  }
                }
              }
            }
